...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header h3 text-center">Créer un item</div>
                        ...
                        <form action="{{ route('admin.items.store') }}" method="POST">
                            ...
                            <ul class="list-group list-group-flush" style="list-style-type:none">
                                ...
                                <li class="list-group-item text-center">
                                    ...
                                    <input id="quantite" name="quantite" type="number" class="form-control text-center mx-auto w-25 d-inline" value="{{ old('quantite') }}" placeholder="Quantité">
                                </li>
                                <li class="list-group-item text-center">
