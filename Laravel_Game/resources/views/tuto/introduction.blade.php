...
@section('content')
    ...
    <div class="container text-justify lead">
        ...
        <div>
            Jadis, quatre peuples se partageaient les terres du continent de NakariK. Chaque civilisation prospérait grâce à ce que leurs terres respectives avaient à leur offrir. Elles se procuraient le reste via les autres nations par la seule route marchande traversant le continent.<br>
            ...
            À l'opposé de la forêt de Falyar, se trouve le tombeau des mille lames, une grande étendue de lames de roches, formée par des millénaires de tempêtes creusant la roche et formant des lames de plusieurs dizaines de mètres de haut. Son nom vient d'une lointaine guerre entre le peuple de Falyar et le peuple de Costpol ayant envoyé chacun cinq cents soldats qui ne revinrent jamais. <br>
